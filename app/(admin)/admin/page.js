  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        {/* Header */}
        <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-3 bg-white rounded-lg px-4 py-3 shadow-sm border border-gray-100">
            ...
            {quickLinks.map((link, index) => {
              ...
              return (
                <Link
                  key={index}
                  href={link.href}
                  className="group relative bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200 p-5 hover:shadow-lg hover:border-blue-300 transition-all duration-300"
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className={`p-3 rounded-lg ${link.bgColor} group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-100 rounded-b-xl overflow-hidden">
                    <div
                      className={`h-full bg-gradient-to-r ${link.color} rounded-b-xl transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left`}
                    />
                  </div>
                </Link>
              );
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                ...
                <span className="text-lg font-bold text-blue-600">{stats.exams}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg">
                ...
                <span className="text-lg font-bold text-purple-600">{stats.subjects}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-indigo-50 to-indigo-100 rounded-lg">
                ...
                <span className="text-lg font-bold text-indigo-600">{stats.units}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-green-50 to-green-100 rounded-lg">
                ...
                <span className="text-lg font-bold text-green-600">{stats.chapters}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg">
                ...
                <span className="text-lg font-bold text-yellow-600">{stats.topics}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-gradient-to-r from-pink-50 to-pink-100 rounded-lg">
                ...
                <span className="text-lg font-bold text-pink-600">{stats.subtopics}</span>
              </div>
            </div>
          </div>
        </div>
